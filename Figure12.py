...
Figure 12. Northern Hemisphere seasonal snow area (a) and mass (b) averaged over 2000-2010 from 
...
sce = np.loadtxt('Figure12scemod.dat')
swe = np.loadtxt('Figure12swemod.dat')
...
sce = np.loadtxt('Figure12sceobs.dat')
swe = np.loadtxt('Figure12sweobs.dat')
